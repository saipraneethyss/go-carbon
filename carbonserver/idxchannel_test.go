...
func (f *testInfo) checkexpandblobs(t *testing.T, query string, shdExist bool){
...
func TestIndexUpdateOverChannel(t *testing.T) {
  ...
  f.checkexpandblobs(t,addMetrics[2],false)
  f.checkexpandblobs(t,addMetrics[0],false)
	...
	f.checkexpandblobs(t,"path.to.file.name1",true)
  f.checkexpandblobs(t,addMetrics[3],true)
	f.checkexpandblobs(t,addMetrics[0],true)
	f.checkexpandblobs(t,addMetrics[4],false)
